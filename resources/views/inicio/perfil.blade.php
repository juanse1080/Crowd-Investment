...
<div class="card mx-auto border-dark bg-light" style="width: 20rem;"><br>
    ...
    background-position: 50%; border-radius: 50%; background-size: 100% auto;" src="{{asset('img/man.png')}}"  alt="Foto estudiante"><br>
    <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item border-imgbg-light"><h5 class="card-title text-center"><i class="far fa-calendar-alt"></i> Fecha {{ucwords(session('datos')['fecha_nacimiento'])}}</h5></li>
    </ul>
